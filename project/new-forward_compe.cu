...
#define MASK_WIDTH 7
#define MASK_SIZE 15000

__constant__ float mask[MASK_SIZE];

__global__ void conv_forward_kernel(float * __restrict__ output, const float * __restrict__ input, const int Map_out, const int Channel, const int Height, const int Width)
{
    /*
    ...
    */
    ...
    const int Height_out = Height - MASK_WIDTH + 1;
    const int Width_out = Width - MASK_WIDTH + 1;
    ...
    #define mask_4d(i3, i2, i1, i0) mask[(i3) * (Channel * MASK_WIDTH * MASK_WIDTH) + (i2) * (MASK_WIDTH * MASK_WIDTH) + (i1) * (MASK_WIDTH) + i0]
...
__host__ void GPUInterface::conv_forward_gpu(float *device_output, const float *device_input, const float *device_mask, const int Batch, const int Map_out, const int Channel, const int Height, const int Width, const int K)
{
    ...
    conv_forward_kernel<<<DimGrid, DimBlock>>>(device_output, device_input, Map_out, Channel, Height, Width);
